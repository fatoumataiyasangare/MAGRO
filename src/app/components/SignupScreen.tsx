...
export default function SignupScreen({ onContinue, onLoginClick }: SignupScreenProps) {
      ...
      <div className="flex-1 flex flex-col justify-center px-6 max-w-md mx-auto w-full">
        ...
        >
          <div className="text-center mb-12">
            ...
            />
            <h2 className="text-xl mb-2">Créer un compte</h2>
            <p className="text-muted-foreground text-sm">Rejoignez la communauté MAGRO</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-muted-foreground">
                ...
                <button onClick={onLoginClick} className="text-primary">
                  Se connecter
                </button>
              </p>
            </div>
